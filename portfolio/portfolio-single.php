...
$after_assoc_work_res = mysqli_fetch_assoc($select_work_res);

$user_id = $after_assoc_work_res['user_id'];
$select_res = "SELECT * FROM users WHERE id=$user_id";
$select_works_res2 = mysqli_query($db_connect, $select_res);
$after_assoc_work = mysqli_fetch_assoc($select_works_res2);
?>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="/part1/upload/work/feat/<?=$after_assoc_work_res['feter']?>" alt="img">
                                </div>
                                <div class="blog-list-content blog-details-content portfolio-details-content">
                                    <h2><?=$after_assoc_work_res['title']?></h2>
                                    <p>
                                    <p><?=$after_assoc_work_res['desp']?></p>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <?php if($after_assoc_work['photo'] == null){?>
                                                <img src="img/blog/post_avatar_img.png" alt="img">
                                                <?php }else{?>
                                                    <img width="100" src="/part1/upload/user/<?=$after_assoc_work['photo']?>" alt="img">
                                                <?php }?>
                                            </div>
                                            <div class="post-avatar-content">
                                                <h5><?=$after_assoc_work['name']?></h5>
