...
$after_assoc = mysqli_fetch_assoc($select_users);

$select_msg = "SELECT * FROM massage WHERE status=0";
$select_count_msg = mysqli_query($db_connect, $select_msg); 

$select_count = "SELECT COUNT(*) as total FROM massage WHERE status=0";
$select_count = mysqli_query($db_connect, $select_count); 
...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="/part1/dashboard_asset/images/favicon.png">
	<link rel="stylesheet" href="/part1/dashboard_asset/vendor/chartist/css/chartist.min.css">
    <link href="/part1/dashboard_asset/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/part1/dashboard_asset/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="/part1/dashboard_asset/css/style.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="/part1/dashboard_asset/images/logo.png" alt="">
                <img class="logo-compact" src="/part1/dashboard_asset/images/logo-text.png" alt="">
                <img class="brand-title" src="/part1/dashboard_asset/images/logo-text.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                                    ...
                                    <div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380">
										<ul class="timeline">
                                                <?php
												 ...
												 foreach($select_count_msg as $msg) {?>
											<li>
												<a href="/part1/massage/massage_view.php?id=<?=$msg['id']?>">
												<div class="timeline-panel">
													<div class="media mr-2">
													<img height="50" src="/part1/dashboard_asset/images/1.jpg" alt="">
													</div>
													<div class="media-body">
														<h6 class="mb-1"><?=$msg['name']?> you Massage</h6>
                            ...
                            <li class="nav-item dropdown header-profile">
								...
								<?php if($after_assoc['photo'] == null) {?>
									<img height="20" src="/part1/dashboard_asset/images/1.jpg" alt="">
									<?php } else {?>
										<img height="20" src="/part1/upload/user/<?=$after_assoc['photo']?>" alt="">
										<?php }?>
									<div class="header-info">
										<span class="text-black"><strong><?=$after_assoc['name']?></span>
										<p class="fs-12 mb-0">Super Admin</p>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="/part1/users/profile.php" class="dropdown-item ai-icon">
                                        <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                                        <span class="ml-2">Profile </span>
                                    </a>
                                    <a href="/part1/logout.php" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="/part1/dashboard.php" aria-expanded="false">
							<i class="flaticon-381-networking"></i>
							<span class="nav-text">Dashboard</span>
						</a>
                        <ul aria-expanded="false">
							<li><a href="/part1/dashboard.php">Dashboard</a></li>
						</ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="/part1/menu/menu.php">Add Menu</a></li>
						</ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/part1/users/user.php">Users List</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/part1/logos/logo.php">Add Logo</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/part1/banner/banner.php">Edit Banner Info</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/part1/social/social.php">Edit Social Info</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/part1/about/about.php">Edit About InFo</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/part1/service/edit_service.php">Edit Services InFo</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/part1/work/work.php">Edit Works InFo</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/part1/counter/counter.php">Edit Counter InFo</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/part1/testimonial/test.php">Edit Testimonial InFo</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							<i class="flaticon-381-television"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="/part1/brand/brand.php">Edit Brands InFo</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="/part1/massage/massage.php" aria-expanded="false">
							<i class="flaticon-381-television"></i>
